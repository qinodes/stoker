...
export function App() {
  ...
  const breadcrumb = navigation.find((item) => item.route === state.route)?.label || (state.modeTransition ? t("common.modeChange") : t("nav.overview"));
...
function ScheduledPage() {
  ...
  return <div className="page-heading"><div><h1>{state.route}</h1><p>{t("scheduled.page.unavailable")}</p></div></div>;
}
