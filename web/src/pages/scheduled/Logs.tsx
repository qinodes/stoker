...
export function ScheduledLogs() {
  ...
  return <>
    <PageHeading eyebrow={t("scheduled.logs.eyebrow")} title={t("scheduled.logs.title")} description={t("scheduled.logs.description")} actions={<button className="button secondary" type="button" onClick={() => void actions.loadScheduledRuns()}>{t("scheduled.refresh")}</button>} />
