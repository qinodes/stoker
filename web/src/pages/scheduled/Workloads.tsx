...
export function Workloads() {
  ...
  return <>
    <PageHeading eyebrow={t("scheduled.workloads.eyebrow")} title={t("scheduled.workloads.title")} description={t("scheduled.workloads.description")} actions={<><button className="button primary" data-action="new-flow" type="button" onClick={() => setCreating(true)}>{t("scheduled.flow.new")}</button><button className="button secondary" type="button" onClick={() => void actions.loadData()}>{t("scheduled.refresh")}</button></>} />
