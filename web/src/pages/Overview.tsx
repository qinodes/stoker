...
export function Overview() {
  ...
  return <>
    <div className="page-heading">
      <div><div className="eyebrow">{t("overview.eyebrow")}</div><h1>{t("overview.title")}</h1><p>{t("overview.description")}</p></div>
      <button className="button secondary" data-action="refresh" onClick={() => void actions.loadData()}>{t("overview.refresh")} <span aria-hidden="true">↻</span></button>
    </div>
