...
export function Logs() {
  ...
  return <>
    <PageHeading eyebrow={t("logs.breadcrumb")} title={t("logs.title")} description={t("logs.description")} actions={<button className="button secondary" data-action="refresh" onClick={() => void actions.loadData()}>{t("logs.refresh")} <span aria-hidden="true">↻</span></button>} />
